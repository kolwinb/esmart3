...
REQUEST_MSG0 = b"\xaa\x01\x01\x01\x00\x03\x00\x00\x1e2"
		...
		for c in data:
			if (self.state == STATE_START):
				...
				if (len(self.data) == self.target_len):
					...
					print ("self.data[2] : {}".format(self.data[2]))
					print ("self.data[3] : {}".format(self.data[3]))
					print ("chg_mode : self.data[7:9] : {}".format(self.data[7:9]))
